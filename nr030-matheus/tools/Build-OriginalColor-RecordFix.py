...
BASE_ZIP_SHA = '4b3e12bf24784699dbb0fc7cc03a6e0af348eb482bd7900db813ecb1c430b7d0'
...
NAME = 'Matheus_NR030_OriginalColor_RecordFix'
REQUIRED = {
...
def main():
    ...
    require(REQUIRED.issubset({t['Name'] for t in report['Tests']}) and report['Passed'] >= 14,
            'Missing-record Windows regression evidence is incomplete')
    ...
    manifest['addon_version'] = '0.2.4-original-color-trial-recordfix1'
    ...
    proof.update(name=NAME, adapter_rebuilt=False, adapter_sha256=ASI_SHA,
                 control_revision='recordfix1', control_source_commit=args.control_source_commit,
